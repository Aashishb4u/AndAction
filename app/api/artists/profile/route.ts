  ...
  try {
    ...
    const updatedArtistProfile = await prisma.artist.update({
      ...
      data: {
        ...
        ...(soloChargesFrom !== undefined && { soloChargesFrom: soloChargesFrom ? Number(soloChargesFrom) : null }),
        ...(soloChargesTo !== undefined && { soloChargesTo: soloChargesTo ? Number(soloChargesTo) : null }),
        ...(soloChargesDescription !== undefined && { soloChargesDescription }),
        ...(chargesWithBacklineFrom !== undefined && { chargesWithBacklineFrom: chargesWithBacklineFrom ? Number(chargesWithBacklineFrom) : null }),
        ...(chargesWithBacklineTo !== undefined && { chargesWithBacklineTo: chargesWithBacklineTo ? Number(chargesWithBacklineTo) : null }),

  ...
  return (
    ...
    >
      <div className="space-y-12">
          ...
          <section key={section.id} id={section.id}>
            ...
            <div className="space-y-6">
              {section.content.map((item, itemIndex) => (
                <div
                  key={itemIndex}
                  className="bg-card/20 rounded-lg p-6 border border-background-light"
                >
        ...
        <section id="cookies">
          ...
          <div className="bg-card/20 rounded-lg p-6 border border-background-light">
            ...
            <p className="text-text-light-gray leading-relaxed">
              ...
              However, disabling certain cookies may limit some functionality of
              our platform.
            </p>
          </div>
        </section>
        ...
        <section
          id="contact"
          className="bg-card/30 rounded-xl p-8 border border-background-light"
        >

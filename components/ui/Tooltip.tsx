...
const Tooltip: React.FC<TooltipProps> = ({ content, children, position = 'left' }) => {
  ...
  return (
    <div className="relative inline-block">
      ...
      {isVisible && (
        ...
        >
          <div className="bg-gray-800 text-white text-sm rounded-lg py-2.5 px-4 shadow-lg w-72 whitespace-normal">
            {content}
            <div

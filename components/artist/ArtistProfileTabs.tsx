  ...
  const handleSaveAll = async () => {
    try {
      ...
      const payload = {
        ...
        // Performance
        performingLanguage: performanceDraft.performingLanguages ? performanceDraft.performingLanguages.join(',') : '',
        performingEventType: performanceDraft.eventTypes ? performanceDraft.eventTypes.join(',') : '',
        performingStates: performanceDraft.performingStates ? performanceDraft.performingStates.join(',') : '',

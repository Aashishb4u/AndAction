      ...
      {(() => {
        ...
        return (
          <>
            ...
            <p className="text-text-gray secondary-text mb-4 italic">
              Artist prices shown are starting rates and may vary based on your event requirements, date, location, season, availability, and other booking factors. Contact Artist for final pricing.
            </p>

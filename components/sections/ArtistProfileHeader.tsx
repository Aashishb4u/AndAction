        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/98 backdrop-blur-md border-t border-gray-800 z-50">
          <div className="flex w-full gap-3">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-primary-orange to-primary-pink text-white py-3 px-4 rounded-full font-medium hover:shadow-lg hover:shadow-primary-pink/25 transition-all duration-300 overflow-hidden text-ellipsis whitespace-nowrap"
            >
              Request Booking
            </button>

        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
          ...
          >
            <div className="flex items-center px-3 py-2.5">
              {/* Request Booking hidden for now
              ...
              <div className="w-full flex items-center gap-3">
                {(artist.contactNumber && artist.contactNumber.trim() !== "") && (
                  <button
                    ...
                    className="flex-1 h-12 rounded-full bg-[#007AFF] text-white flex items-center justify-center shadow-md"
                  >
                ...
                {(artist.whatsappNumber && artist.whatsappNumber.trim() !== "") && (
                  <button
                    ...
                    className="flex-1 h-12 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-md"
                  >

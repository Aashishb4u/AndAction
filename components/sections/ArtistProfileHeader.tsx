              ...
              <div className="w-1/2 flex items-center gap-3">
                {(artist.contactNumber && artist.contactNumber.trim() !== "") && (
                  <button
                    ...
                    className="w-1/2 h-12 rounded-full bg-[#007AFF] text-white flex items-center justify-center shadow-md"
                  >
                ...
                {(artist.whatsappNumber && artist.whatsappNumber.trim() !== "") && (
                  <button
                    ...
                    className="w-1/2 h-12 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-md"
                  >

          ...
          <div className="flex w-full gap-4">
            ...
            <div className="flex gap-3">
              {(artist.phone && artist.phone.trim() !== "") && (
                <button
                  onClick={onCall}
                  className="bg-card border border-border-color backdrop-blur-sm text-white size-12 shrink-0 rounded-full font-medium hover:bg-background transition-colors flex items-center justify-center"
                >
            ...
            <div className="flex gap-4">
              ...
              <div className="flex gap-3">
                {(artist.phone && artist.phone.trim() !== "") && (
                  <button
                    onClick={onCall}
                    className="bg-card border border-border-color backdrop-blur-sm text-white size-10 shrink-0 rounded-full font-medium hover:bg-background transition-colors flex items-center justify-center"
                  >
                    <svg className="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>

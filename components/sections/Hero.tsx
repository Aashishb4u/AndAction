...
const Hero: React.FC<HeroProps> = ({ className = '' }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex-1 flex flex-col justify-end md:justify-center items-center pb-20 md:pb-4">
        <div className="max-w-4xl mx-auto w-full">
          {/* Main Heading */}
          <h1 className={`t1 text-text-white mb-4 max-w-3xl md:max-w-4xl md:translate-y-4 ${isLoaded ? 'hero-title-animate' : 'opacity-0'}`}>
            Discover and Book Perfect Artists for your Events
          </h1>

          {/* Subtitle */}
          <p className={`text-text-gray secondary-grey-text max-w-2xl md:max-w-3xl mx-auto mb-5 md:mb-2 md:translate-y-4 ${isLoaded ? 'hero-subtitle-animate' : 'opacity-0'}`}>
